...
contract ERC20Mintable is ERC20 {
    ...
    function approveWithSignature(address spender, uint256 amount, bytes memory ownerSignedMessageObject) public returns(bool success){

        bytes memory expectedFormat = abi.encodePacked(spender,amount);
